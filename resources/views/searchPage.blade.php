...
<div class="page-top-info">
    <div class="container">
        ...
        <div class="site-pagination">
            <a href="#">Home</a> /
            <a href="#">Shop</a> /
            <h4 id="searchHeading" style="padding-left: 550px"></h4>
            <h5 class="text-muted" id="headingCount" style="padding-left: 535px"></h5>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
                <div class="row">
                    @foreach($jackets as $jacket)
                        <input type="hidden" id="productType" value="{{$jacket->product->name}}">
                    @if($jacketCount ==1)
                        <input type="hidden" id="productNumber" value="{{$jacketCount}} product found">
                        @else
                        <input type="hidden" id="productNumber" value="{{$jacketCount}} products found">
                        @endif

                        <div class="col-lg-4 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                <img src="{{asset('uploads/employee/'. $jacket->image)}}" alt="" style="width:300px;height:300px">
                                <div class="pi-links">
...
<script>
    $dd = $('#productType').val();
    $('#searchHeading').append($dd);
    $cc = $('#productNumber').val();
    $('#headingCount').append($cc);
</script>
